...
<?php wp_body_open(); ?>
	...
	<?php endif; ?>
		...
		<?php if($cbtoolkit_preloader) : ?>
			<!-- preloader begin -->
			<div class="oslabs-rv-preloader">
				<div class="oslabs-rv-preloader-inner-3421">
					<div class="oslabs-rv-scene">
						<svg viewBox="0 0 58 58" id="oslabs-rv-mustard-2344" class="oslabs-rv-product-3244">
							<g>
						...
						<svg viewBox="0 0 49.818 49.818" id="meat" class="oslabs-rv-product-3244">
							<g>
						...
						<svg viewBox="0 0 49 49" id="soda" class="oslabs-rv-product-3244">
							<g>
						...
						<div class="oslabs-rv-cart-container">
							<svg  viewBox="0 0 512 512" id="oslabs-rv-cart-2344">
...
<!-- header start -->
<?php do_action( 'oslabs_header_style' );?>
<!-- header end -->
<!-- before main content start -->
<?php do_action( 'oslabs_before_main_content' );?>
