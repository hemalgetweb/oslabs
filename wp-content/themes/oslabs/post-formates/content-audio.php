<?php
$oslabs_audio_url = function_exists('get_field') ? get_field('fromate_style') : NULL;
...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('oslabs-fz-blog-box-447 mb-40 format-audio'); ?>>
    <?php if (!empty($oslabs_audio_url)) : ?>
        <div class="postbox__audio embed-responsive embed-responsive-16by9 oslabs-fz-thumbnail-image oslabs-fz-blog-thumbnail-447">
            <?php echo wp_oembed_get($oslabs_audio_url); ?>
