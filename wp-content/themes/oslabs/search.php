...
<main id="primary" class="oslabs-blog-page-area oslabs-blog-has-search pt-100 pb-60 <?php echo esc_attr($sidebar_class); ?>">
		<div class="container">
						...
						<?php
							...
							<?php
								...
								*/
								...
								endwhile;
							?>
								<?php oslabs_pagination( '<i class="fal fa-long-arrow-left"></i>', '<i class="fal fa-long-arrow-right"></i>', '', ['class' => ''] );?>
							<?php
							else:
