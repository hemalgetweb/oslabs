...
Class CB_Toolkit_Banner extends WP_Widget{
	...
	public function widget($args, $instance){
		...
		$image_uri = $instance['image_uri'] ? $instance['image_uri']:'';?>
		 <div class="oslabs-blog-sidebar oslabs-blog-sidebar-ad text-center" data-background="<?php echo esc_url($image_uri); ?>">
			<?php if(!empty($title)) : ?>
				<h4 class="oslabs-add-title"><?php echo esc_html($title); ?></h4>
			<?php endif; ?>
			<?php if(!empty($content)) : ?>
				<p><?php echo esc_html($content); ?></p>
			<?php endif; ?>
			<?php if(!empty($btn_text)) : ?>
				<a href="<?php echo esc_url($btn_link); ?>" class="oslabs-add-btn"><?php echo esc_html($btn_text); ?></a>
			<?php endif; ?>
		</div>
