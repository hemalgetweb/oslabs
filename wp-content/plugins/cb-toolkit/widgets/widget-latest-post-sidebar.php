...
Class Latest_posts_sidebar_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct( 'cb-latest-posts', __('CB Toolkit Sidebar Posts Image', 'cb-toolkit'), [
            'description' => __('Latest Post Widget by oslabs', 'cb-toolkit'),
        ] );
    }
        ...
        if ( $instance['title'] ):
            echo $before_title;?>
			 ...
			 <div class="blog-sidebar-box-body">
				...
				?>
				<div class="oslabs-sidebar-recent-post mb-20">
					<div class="oslabs-sidebar-recent-post-img">
						<a href="<?php echo esc_url(get_the_permalink());?>">
							<img src="<?php print esc_url( get_the_post_thumbnail_url( get_the_ID(), 'full' ) );?>" alt="<?php echo esc_attr($image_alt); ?>">
						</a>
					</div>
					<div class="oslabs-fz-recent-post-content-447-448">
					<div class="oslabs-fz-blog-meta-wrap-447">
