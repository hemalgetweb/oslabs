<?php
	...
	class cb_subscriber_widget  extends WP_Widget{
		...
		<span class="oslabs-fz-footer-widget-subscribe-subtitle-4"><?php echo  $instance['info']; ?></span>
		<?php endif; ?>
			<div class="oslabs-fz-footer-widget-subscribe-form-4 mb-25">
				<?php if( !empty($mailchimp_shortcode) ): ?>
					<?php print do_shortcode($mailchimp_shortcode); ?>
				<?php endif; ?>
			</div>
			<div class="oslabs-fz-footer-widget-app-wrapper-4">
				<div class="item-1">
					<a href="<?php echo esc_url($play_store_link); ?>" target="_blank"><img src="https://oslabswp.codebasket.net/fashion/wp-content/uploads/sites/4/2023/02/google-play.png" alt="Play store"></a>
				</div>
				<div class="item-2">
					<a href="<?php echo esc_url($app_store_link); ?>" target="_blank"><img src="https://oslabswp.codebasket.net/fashion/wp-content/uploads/sites/4/2023/02/app-store.png" alt="Apple store"></a>
				</div>
			</div>
		<?php
		}
