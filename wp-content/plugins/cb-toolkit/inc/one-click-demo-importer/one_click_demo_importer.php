...
function ocdi_import_files() {
    return [
      [
        ...
        'preview_url'                  => 'https://oslabswp.codebasket.net/electronics-2/',
      ],
      [
        ...
        'preview_url'                  => 'https://oslabswp.codebasket.net/wine/',
      ],
      [
        ...
        'preview_url'                  => 'https://oslabswp.codebasket.net/watch/',
      ],
      [
        ...
        'preview_url'                  => 'https://oslabswp.codebasket.net/fashion/',
      ],
    ];
  }
