...
class CB_Core_Feature_List extends Widget_Base
{
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Feature List Content', 'cb-core'),
			]
		);
		...
		$repeater = new \Elementor\Repeater();
		 ...
		 'feature_title',
		  [
			 ...
			 'placeholder' => esc_html__( 'Feature Title', 'cb-core' ),
			 'label_block' => true,
			 'condition' => [
		 ...
		 'feature_excerpt',
		  [
			 'label'       => esc_html__( 'Feature Excerpt', 'cb-core' ),
			 'type'        => \Elementor\Controls_Manager::TEXTAREA,
			 'placeholder' => esc_html__( 'Feature Excerpt', 'cb-core' ),
			 'label_block' => true,
			 'condition' => [
				'field_condition' => ['style-1']
			 ]
