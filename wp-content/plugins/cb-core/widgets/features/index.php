 ...
 * @since 1.0.0
 */
class CB_Core_Feature extends Widget_Base
{
  ...
  protected function register_controls()
  {
    ...
    $this->add_control(
      'reverce_feature',
      [
        'label' => esc_html__('Reverce Feature?', 'Text-domain'),
    ...
    $this->add_control(
      'feature_image',
      [
        'label' => esc_html__('Feature Image', 'cb-core'),
        'label_block' => true,
    ...
    $this->add_control(
      'feature_title',
      [
        'label' => esc_html__('Feature Title', 'cb-core'),
        'label_block' => true,
    ...
    $this->add_control(
      'feature_intro',
      [
        'label' => esc_html__('Feature intro', 'cb-core'),
        'label_block' => true,
        'type' => \Elementor\Controls_Manager::TEXT,
        'condition' => [
          'layout' => ['layout-1']
...
Plugin::instance()->widgets_manager->register(new CB_Core_Feature());